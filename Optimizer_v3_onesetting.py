...
demand_mults_average = demand_mults.mean()
#%%
comparison_dataframe = pd.DataFrame()

filename2 = change_demands(filename, demand_mults_average)
...
#%%
comparison_dataframe.to_csv(filename.stem+'Results_OneSetting.csv')